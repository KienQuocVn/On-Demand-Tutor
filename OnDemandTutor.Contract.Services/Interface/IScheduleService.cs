...
namespace OnDemandTutor.Contract.Services.Interface
{
    public interface IScheduleService
    {
        ...
        Task<ResponseScheduleModelViews> UpdateScheduleAsync(Guid id, UpdateScheduleModelViews schedule);
        Task<ResponseScheduleModelViews> DeleteScheduleAsync(Guid id);
    }
}
